        ...
        <Slide right>
          <div className="experience__job">
            <div className="job__period">
              <h4 className="time-stamps">2023</h4>
              <h5>
                <small>
                  6<sup>th</sup> June
                </small>{" "}
            ...
            <div className="job__details">
              ...
              <h5 className="company__name">
                {" "}
                <a href="https://www.mordorintelligence.com/" target="_blank">
                  Mordor Intelligence
                </a>
              </h5>
              <p className="job__description">
                {/* I joined <strong>Mordor Intelligence</strong> as a{" "}
                <strong>Software Engineer.</strong> */}
                {/* <span className="worded__tech__stack">
                  "JavaScript, React, Next.js, ExpressJS, EJS, Ant Design,
                  Material UI, Styled Component and many more..."
                </span> */}
                <h4 style={{ marginTop: "15px" }}>Responsibilities:</h4>
                <ul className="working-key-point">
                  <li>
                    Developed key templates for Report Descriptions, Categories,
                    Hubs, and Company pages, which contributing to 90% of the
                    company’s revenue.
                  </li>
                  <li>
                    Led frontend optimization initiatives, enhancing core web
                    vitals and increasing website traffic by 10%, thereby
                    improving Google rankings.
                  </li>
                  <li>
                    Executed critical frontend improvements in the lead
                    generation section, vital for securing revenue from
            ...
            <div className="job__details">
              ...
              <h2 className="job__title"> Junior Software Engineer</h2>
              <h5 className="company__name">
                {" "}
                <a href="https://www.mordorintelligence.com/" target="_blank">
                  Mordor Intelligence
